...
{
    public function testNoopWhenWorkerHasNoRegisteredProcesses(): void
    {
        $driver = new class ([1]) extends SwooleDriver {
            public array $calls = [];
    ...
    public function testDefersUntilOutsideCoroutine(): void
    {
        ...
        $driver->spawnProcess(static fn () => new \stdClass(), null, 0);
        $driver->startForWorker(0);
